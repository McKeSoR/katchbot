console.log('')
console.log('-------------------------------')
console.log('  Скрипт Youn Bot запущен.')
console.log('  Разработчик: Артём Амирян')
console.log('  vk.com/junior26')
...
Беседа с ботом: vk.me/join/AJQ1d7UVgBhR1_nwuG0Mjdan`,
		{
...
${message.user.transport.car === 17 ? '🔹' : '🔸'} 17. Гелендвагин G65 (3.000.000$)
...
${message.user.transport.car === 26 ? '🔹' : '🔸'} 26. Mercedes Benz S-klass (135.000.000$)
${message.user.transport.car === 27 ? '🔹' : '🔸'} 27. Mercedes Benz Maybach Exelero (145.000.000$)
${message.user.transport.car === 28 ? '🔹' : '🔸'} 28. Lamborghini Veneno (150.000.000$)
${message.user.transport.car === 29 ? '🔹' : '🔸'} 29. Rolls-Royce Sweptail (200.000.000$)
...
${message.user.misc.phone === 10 ? '🔹' : '🔸'} 10. iPhone XS (150.000$)
${message.user.misc.phone === 11 ? '🔹' : '🔸'} 11. iPhone XS Max (200.000$)
${message.user.misc.phone === 12 ? '🔹' : '🔸'} 12. iPhone 11 (210.000$)
${message.user.misc.phone === 13 ? '🔹' : '🔸'} 13. iPhone 11 Pro Max (250.000$)
${message.user.misc.phone === 14 ? '🔹' : '🔸'} 14. Мегафон С1 (270.000$)
...
cmd.hear(/^(?:беседа с ботом|беседа|ссылка на беседу)$/i, async (message, bot) => {
	return bot(`беседа с ботом: vk.me/join/AJQ1d7UVgBhR1_nwuG0Mjdan`);
});
...
bot.login(process.nextTick.TOKEN);
//bot.login("")